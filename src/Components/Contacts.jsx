...
const onSubmit = async (event) =>{
    ...
    formData.append("access_key", "c40a2148-b51d-4988-b315-a71b4c349d5d");
...
p-3 text-sm outline-none' required />
                ...
                <div>
                    <p className='mb-2 text-sm font-medium'>Emai id</p>
                    <div className='flex pl-3 rounded-lg border border-gray-300
dark:border-grey-600'>
                        <img src={assets.email_icon} alt="" />
                        <input name="email" placeholder='Enter your email' className='w-full
p-3 text-sm outline-none' required />
                    </div>
                </div>
